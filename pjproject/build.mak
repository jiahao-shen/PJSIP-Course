...
# FFMPEG flags
FFMPEG_CFLAGS =  -DPJMEDIA_HAS_LIBAVDEVICE=1 -DPJMEDIA_HAS_LIBAVFORMAT=1 -DPJMEDIA_HAS_LIBAVCODEC=1 -DPJMEDIA_HAS_LIBSWSCALE=1 -DPJMEDIA_HAS_LIBAVUTIL=1 -I/usr/local/Cellar/ffmpeg/4.2.1_2/include 
FFMPEG_LDFLAGS =   -L/usr/local/Cellar/ffmpeg/4.2.1_2/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil
...
# OPENH264 flags
OPENH264_CFLAGS = -DPJMEDIA_HAS_OPENH264_CODEC=1  
OPENH264_LDFLAGS =   -lopenh264 -lstdc++
