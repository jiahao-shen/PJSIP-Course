export PJDIR := /Users/sam/Code/PJSIP-Lab/pjproject
...
export CC_NAME := gcc
export TARGET_ARCH := 
export TARGET_NAME := x86_64-apple-darwin19.0.0
...
# SDL flags
SDL_CFLAGS = -DPJMEDIA_VIDEO_DEV_HAS_SDL=1 -I/usr/local/include/SDL2 -D_THREAD_SAFE
SDL_LDFLAGS = -L/usr/local/lib -lSDL2

# FFMPEG flags
FFMPEG_CFLAGS =  -DPJMEDIA_HAS_LIBAVDEVICE=1 -DPJMEDIA_HAS_LIBAVFORMAT=1 -DPJMEDIA_HAS_LIBAVCODEC=1 -DPJMEDIA_HAS_LIBSWSCALE=1 -DPJMEDIA_HAS_LIBAVUTIL=1 -I/usr/local/Cellar/ffmpeg/4.2.1_1/include 
FFMPEG_LDFLAGS =   -L/usr/local/Cellar/ffmpeg/4.2.1_1/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lopus -lm -lpthread  -framework CoreAudio -framework CoreServices -framework AudioUnit -framework AudioToolbox -framework Foundation -framework AppKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework VideoToolbox -L/usr/local/lib -lSDL2  -L/usr/local/Cellar/ffmpeg/4.2.1_1/lib -lavdevice -lavformat -lavcodec -lswscale -lavutil -framework Security -lopencore-amrnb -lopencore-amrwb
